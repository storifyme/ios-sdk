...
#ifndef STORIFYME_SWIFT_H
#define STORIFYME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StorifyMe",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC9StorifyMe16Cube3dScrollView")
@interface Cube3dScrollView : UIScrollView <UIScrollViewDelegate>
- (void)awakeFromNib;
...
/// This method is call whe user is tap to item (select item)
